...
class Banner extends CI_controller
{
    ...
    public function listarLateral()
    {
        ...
        if($usuario->nivel == "admin")
        {
            ...
            // Carrega a view
            $this->view("painel/banner-lateral/listar",$dados);
        }
        else
        {
            // 404
     ...
     * @method GET
     */
    public function inserirLateral()
    {
        // Verifica a permissão do usuario
        $usuario = $this->objHelperApoio->seguranca();
        ...
        if($usuario->nivel == "admin")
        {
            ...
            // Carrega a view
            $this->view("painel/banner-lateral/cadastrar", $dados);
        }
        else
        {
            // 404
