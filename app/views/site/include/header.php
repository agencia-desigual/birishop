                    ...
                    <div class="col-lg-2">
                        <div class="logo-area">
                            <a href="<?= BASE_URL ?>" class="temp-logo">
                                <img src="<?= BASE_URL; ?>assets/theme/site/media/logo-dark.png" alt="logo" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 d-flex justify-content-end">
                        <div class="header-action-layout1">
                            <ul>
                                ...
                                <li class="header-btn">
                                    <a href="<?= BASE_URL; ?>cadastro" class="item-btn"><i class="fas fa-plus"></i>Seja um Associado</a>
                                </li>
                            </ul>
                        </div>
                    </div>
