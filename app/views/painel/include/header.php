                    ...
                    <?php if ($usuario->nivel == "associado") : ?>
                        ...
                        <li>
                            <a href="javascript:void(0);" class="waves-effect">
                                ...
                                <span>
                                Promoções <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span>
                            </span>
                            </a>
                            <ul class="submenu">
                                <li><a href="<?= BASE_URL ?>painel/promocoes">Listar Todos</a></li>
                                <li><a href="<?= BASE_URL ?>painel/promocao/inserir">Adicionar</a></li>
                            </ul>
                        </li>
