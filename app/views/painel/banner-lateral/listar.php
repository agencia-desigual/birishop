                ...
                <div class="col-12">
                    <div class="card m-b-30">
                        <div class="card-body">
                            ...
                            <h4 class="mt-0 header-title">TODOS OS BANNERS LATERAL</h4>
                            <p class="sub-title../plugins">Gerencie seus banners laterais, selecione as melhores imagens.</p>
                            <hr class="mt-3 mb-3">
                            <div class="row">
                                ...
                                <?php else: ?>
                                    <div class="col-md-12">
                                        <h6 class="mb-4">Não possui nenhum banner lateral cadastrado. </h6>

                                        <a href="<?= BASE_URL ?>painel/banner-lateral/inserir" class="btn btn-primary mb-3">Adicionar um banner</a>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
